    ...
    beats={[
      {
        ...
        back: <Plate src="mfba/meal-bbq.jpg" focus="center 35%" dim={0.5} />,
        node: <AthleticBeat label="Nutrition" lines={["1,534 calories.", "170g protein.", "Every day."]} hot="170g" />,
      },
      {
        key: "prep",
        duration: DIET_BEATS[1],
        back: <Plate src="mfba/meal-bbq.jpg" focus="center 70%" from={1.16} dim={0.56} />,
        node: (
          <AthleticQuote
      ...
      },
      {
        ...
        back: <Plate src="mfba/meal-bbq.jpg" focus="center 50%" dim={0.52} />,
